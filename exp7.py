...
# exp7: batch size 128, add two layers to generator
...
def plotGeneratedImages(imagename):
    np.random.seed(504)
    h = w = 28
    num_gen = 25
    ...
    GeneratedImages.savefig("GeneratedImages/"+imagename)
    plt.show()
...
for i in range(1,epochCount+1):
    ...
    if i == 1 or i % 20 == 0:
        plotGeneratedImages("exp7_%d_epoch.png"%i)
...
LossFigure.savefig("LossFigures/exp7_loss.png")
plt.show()
...
plotGeneratedImages("exp7_res.png")
